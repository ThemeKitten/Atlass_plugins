...
Config::Set('acl.vote.image.limit_time', 9999*9999*24*20); // время голосования за картинку
...
return array(
    ...
    'images_new_time' => 999999999*9999999999*9999999999*1, // сколько времени картинка считается лучшей
    'images_best' => 0, // мин рейтинг для попадания картинки в топ
    'image_row' => 6, // кол-во изображений в блоке садйбара
    'images_random' => 64, // кол-во изображений в блоке случайные картинки
    'album_block' => 64, // кол-во изображений в блоке альбомов
